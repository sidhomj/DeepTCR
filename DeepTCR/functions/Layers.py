...
def Conv_Model(GO, self, trainable_embedding, kernel, use_only_seq,
    ...
    GO.prob_mask = tf.compat.v1.placeholder_with_default(0.0, shape=(), name='prob_mask')
    ...
    if self.use_alpha is True:
        GO.X_Seq_alpha = tf.compat.v1.placeholder(tf.int64,
                                        ...
                                        name='Input_Alpha')
        GO.X_Seq_alpha_mask = return_masked_input(GO.X_Seq_alpha,GO.prob_mask)
    ...
    if self.use_beta is True:
        GO.X_Seq_beta = tf.compat.v1.placeholder(tf.int64,
                                       ...
                                       name='Input_Beta')
        GO.X_Seq_beta_mask = return_masked_input(GO.X_Seq_beta,GO.prob_mask)
