...
df_out.to_csv(method_dim+'_Dash.csv',index=False)
...
df_gan = pd.read_csv('GAN_Dash.csv')
df_vae = pd.read_csv('VAE_Dash.csv')
plt.figure()
...
plt.ylim(0,100)
plt.legend()
plt.savefig('Specificity_Clustering_Dash.tif')
...
ax1.set_xlabel('')
plt.savefig('Cluster_Characteristics_Dash.tif')
